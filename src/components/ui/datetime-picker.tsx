...
export function DateTimePicker({
  ...
  const isDateDisabled = (date: Date) => {
    ...
    if (minDate && dateStr < minDate.split('T')[0]) return true
    if (maxDate && dateStr > maxDate.split('T')[0]) return true
    return false
  }
  ...
  const handleDateSelect = (date: Date) => {
    ...
    const newDateTime = formatDateTime(date, selectedTime)
        ...
        <div className="absolute z-50 mt-1 w-80 bg-white border border-slate-200 rounded-lg shadow-lg p-4">
          ...
          <div className="border-t border-slate-200 pt-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-slate-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            />
          </div>
